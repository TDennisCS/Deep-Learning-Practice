...
template <typename Domain> Domain Perceptron (std::vector<Domain> weightsVector, std::vector<Domain> inputsVector, Domain bias, Domain activationFuntion, int layers); // y = g(z), z = w0 + X * W
